...
class StdOutReporter(BaseReporter):
    ...
    def __init__(self, num_gens_to_store=1, file_name='neat-stats-'):
        self.dict = {'Generation':[], 'Population_size':[], 'Num_species':[], 'list_of_[ID,age,size,fitness,adj_fit,stag]':[], 'Total_extinctions':[], 'Generation_time':[], 'Average_time':[], 'Average_fitness':[], 'Stdev_fitness':[], 'Best_genome_fitness':[]}
